...
<div className="hero min-h-screen " style={{ backgroundImage: `url(${img1})` }}>
  ...
  <div className="hero-content text-center text-neutral-content">
    <div className="max-w-md">
      <h1 className="mb-5 text-5xl font-bold" data-aos="fade-up"><span>Welcome To </span>TinkerToysHaven</h1>
      ...
      <button className="btn text-black bg-[#74C4F7] hover:bg-[#74C4F7] border-none">Read More..</button>
    </div>
  </div>
</div>
    </div>
